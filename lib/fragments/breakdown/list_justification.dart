...
class JustificationList extends StatefulWidget {
  String tittle;
  JustificationList({Key key, @required this.tittle}) : super(key: key);
...
class _JustificationListState extends State<JustificationList> {
  ...
  Widget buildList(width, DigiPMProvider digiPM, BreakdownProvider breakdown, context) {
    if (breakdown.isLoading) {
      ...
      if (breakdown.dataJustification.length == 0) {
                                    ...
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: <Widget>[
                                          Expanded(
                                            flex: 1,
                                            child: Text(breakdown.dataJustification[int]['IS_NEED_SPARE_PART_PM02'] == '1' ? 'Using Sparepart' : 'Without Sparepart', style: TextStyle(color: Colors.black87),),
                                          ),
                                        ],
                                      ),
                                    ),
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: <Widget>[
                                          ...
                                          sizeWidth5(),
                                          buttonCardJustify(context, breakdown, Colors.green, 'Justify', int),
                                        ],
                                      ),
                                    ),
                                  ],
  ...
  Widget buttonCardJustify (context, BreakdownProvider breakdown, Color colorCard, String text, int index)  {
    return RaisedButton(
      onPressed: () {
        onActionPM02(context,  "Confirmation",
            "Will you do the execution for \n" + breakdown.dataJustification[index]['ewo_number'] + " ?",  breakdown, index);
      },
      textColor: Colors.white,
      color: colorCard,
      padding:
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            FlatButton(
              ...
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) =>
                    FormJustification1(data: breakdown.dataJustification[index],)
                ));
