...
class ListCorrectiveBreakdown extends StatefulWidget {
  @override
  _ListCorrectiveBreakdownState createState() => _ListCorrectiveBreakdownState();
}

class _ListCorrectiveBreakdownState extends State<ListCorrectiveBreakdown> {
  ...
  Widget buildList(width, DigiPMProvider digiPM, BreakdownProvider breakdown, context) {
    if (breakdown.isLoading) {
      ...
      if (breakdown.dataBreakdownAction == null || breakdown.dataBreakdownAction.length == 0) {
