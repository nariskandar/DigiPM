...
import 'package:digi_pm_skin/fragments/abnormality/root_cause_justification.dart';
...
class AbnormalityPage extends StatefulWidget {
  @override
  _AbnormalityPageState createState() => _AbnormalityPageState();
}

class _AbnormalityPageState extends State<AbnormalityPage> {
  List<String> events = [
                  ...
                  onTap: () {
                    if (title == "Abnormality Submissions") {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => Submissions()));
