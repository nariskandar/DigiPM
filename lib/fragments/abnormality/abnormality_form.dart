...
class _AbnormalityForm1State extends State<AbnormalityForm1> {
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                      ...
                                      Container(
                                          child: GridView.count(
                                            ...
                                            children: List.generate(
                                              ...
                                              abnormality.submissionProperty['photo_submission'];
                                ...
                                space20(),
                                TextBoxQuestion(context, digiPM, abnormality, 'SIAPA/WHO', 'WHO'),
                                space20(),
  ...
  onValidateForm(BuildContext context, AbnormalityProvider abnormality) {
    ...
    if(abnormality.submissionProperty['photo_submission'][0]['img_path'] == null){
      Util.alert(
          context,
          "Validation Error",
          "Please upload a photo of at least 1 ");
      return null;
    }
  ...
  saveForm(BuildContext context, AbnormalityProvider abnormality) async {
    ...
    var data = {
      ...
      'payload' : {
        'id' : abnormality.submissionProperty['id'],
