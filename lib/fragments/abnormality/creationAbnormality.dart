...
class _CreationState extends State<Creation> {
  ...
  Widget buildList(width, DigiPMProvider digiPM, AbnormalityProvider abnormality, context) {
    if (abnormality.isLoading) {
      ...
      if (abnormality.dataWOCreation == null || abnormality.dataWOCreation == []) {
          ...
          children: <Widget>[
            Expanded(
              ...
              child: ListView.builder(
                itemCount: abnormality.dataWOCreation.length,
                                ...
                                child: Stack(
                                  children: <Widget>[
                                    Align(
                                      ...
                                      child: RichText(
                                        text: TextSpan(
                                          text: abnormality.dataWOCreation[int]
                                          ['created_at'],
                                          style: TextStyle(
                                                  ...
                                                  child: Row(
                                                    children: <Widget>[
                                                      RichText(
                                                        ...
                                                        TextAlign.left,
                                                        text: TextSpan(
                                                          text: abnormality.dataWOCreation[
                                                          int][
                                                          'problem_description'],
                                                          style: TextStyle(
                                                            color:
      ...
      onPressed: () {
        ...
        Navigator.push(context, MaterialPageRoute(
            builder: (context) => Timeline(
                ewoId: abnormality.dataWOCreation[int]['id'],
                pm_type: 'PM03',
            )
        ));
      },
